# ba06d858-cedb-4b5c-b4c8-1460eb98fbc4 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `mobile-app-nexus-edu-final.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `mobile-app-nexus-edu-final.html`
...
- A single self-contained `mobile-app-nexus-edu-final.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `mobile-app-nexus-edu-final.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `mobile-app-nexus-edu-final.html`
- `mobile-app-nexus-edu-flashcards.html`
- `mobile-app-nexus-edu-onboarding-2-2.html`
- `mobile-app-nexus-edu-onboarding-2.html`
- `mobile-app-nexus-edu-onboarding-final.html`
- `mobile-app-nexus-edu-onboarding.html`
- `mobile-app-nexus-edu-profile.html`
- `mobile-app-nexus-edu-refined.html`
- `mobile-app-nexus-edu-scanner.html`
- `mobile-app-nexus-edu-tutor-2.html`
- `mobile-app-nexus-edu-tutor-refined.html`
- `mobile-app-nexus-edu-tutor.html`
...
1. Inspect `mobile-app-nexus-edu-final.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
